...
<head>
    ...
    <title>Apply for Bike Loan</title>
    <link rel="icon" type="img/png" href="bike.png">
...
<body>
<form action="loanphp.php" method="post" onsubmit="bike()">
    <h1 id="phead">Application For Two-Wheeler Loan</h1><hr>
    <div id="perdiv">
    ...
    <div id="kycdiv">
        ...
        <input type="number" id="aathar" name="aatharno" placeholder="0000-0000-0000" class="kycinput" onkeypress="if(this.value.length==12) return false;">
        ...
        <input type="text" id="ifcode" name="ifcode" placeholder="CNRB0002963" class="kycinput" maxlength="15" min="0">
    </div>
    <br>
    <hr>
    <div id="comdiv">
    ...
    <hr>
    <div id="bmdiv">
        <h2 id="head6">Two Wheeler Information</h2>
        <label for="bikename" id="bikename1" class="bmlabel">Bike Name:</label>
        <input type="text" id="bikename" name="bikename" placeholder="Bike Name" class="bminput">
        <label for="bmodel" id="bmodel1" class="bmlabel">Bike Model:</label>
        <input type="text" id="bmodel" name="bikemodel" placeholder="Bike Model" class="bminput"><br>
        <br>
        <label for="agency" id="agency1" class="bmlabel">Agency Name:</label>
        <input type="text" id="agency" name="agency" placeholder="Agency Name" class="bminput">
        <label for="tcb" id="tcb1" class="bmlabel">Total Cost Of Bike:</label>
        <input type="number" id="tcb" name="tcb" placeholder="Total Cost of Bike" class="bminput" onkeypress="if(this.value.length==6) return false;">
        <br>
        <br>
        <label for="lmr" id="lmr1" class="bmlabel">Loan Amount Required:</label>
        <input type="number" id="lmr" name="lar" placeholder="Loan Amount Required" class="bminput" onkeypress="if(this.value.length==5) return false;">
    </div>
    <br>
    <br>
    <input name="bikesubmit" type="submit" id="submit" value="Submit">
</form>
</body>
</html>