...
<head>
    ...
    <title>Apply for Buisness Loan</title>
    <link rel="icon" type="img/png" href="buisness.png">
    <link rel="stylesheet" type="text/css" href="buisnesscss.css">
...
<body>
<form action="loanphp.php" method="POST" onsubmit="buisness()">
    <h1 id="phead">Application For Buisness Loan</h1><hr>
    <div id="perdiv">
      ...
      <input id="dob" name="dob" placeholder="DD/MM/YYYY" class="perinput" onmouseenter="(this.type='date')" onmouseleave="(this.type='Text')" >
      <label for="age" id="age1" class="perlabel">Age:</label>
      <input type="number" name="age" id="age" placeholder="Age" class="perinput" onkeypress="if(this.value.length==2) return false;">
    </div>
    <br>
    <hr>
    <div id="kycdiv">
        ...
        <input type="number" name="aatharno" id="aathar" placeholder="0000-0000-0000" class="kycinput" onkeypress="if(this.value.length==12) return false;">
        <label for="pan" id="pan1" class="kyclabel">PAN Number:</label>
        <input type="text" id="pan" name="panno" placeholder="ABCDE0000F" class="kycinput" maxlength="10"><br>
        <br>
        <label for="faid" id="faid1" class="kyclabel">Family Id:</label>
        <input type="text" id="faid" name="famid" placeholder="Ration Card Number" class="kycinput">
        <label for="accn" id="acc" class="kyclabel">Account Number:</label>
        <input type="number" id="accn" name="accno" placeholder="0000000000000" class="kycinput">
        <br>
        <br>
        ...
        <input type="text" id="ifcode" name="ifcode" placeholder="CNRB0002963" class="kycinput">
    </div>
    <br>
    <hr>
    <div id="comdiv">
        ...
        <input type="number" id="mobile" name="m1" placeholder="9363486483" class="cominput" onkeypress="if(this.value.length==10) return false;">
        <label for="mobile2" id="mobile22" class="comlabel">Alternate Number:</label>
        <input type="number" id="mobile2" name="m2" placeholder="9345501339" class="cominput" onkeypress="if(this.value.length==10) return false;"><br>
        <br>
    ...
    <hr>
    <div id="buisnessdiv">
        <h2 id="head6">Buisness Details</h2>
        <label for="buisname" id="buisname1" class="buislabel">Buisness Name:</label>
        <input type="text" id="buisname" name="buisname" placeholder="Buisness Name" class="buisinput"><br>
        <br>
        <label for="bmode" id="bmode1" class="buislabel">Mode Of Buisness:</label>
        <input type="text" id="bmode" name="buismode" placeholder="Like Manufacturing" class="buisinput">
        <label for="fo" id="fo1" class="buislabel">First Owner:</label>
        <input type="text" id="fo" name="fo" placeholder="Owner" class="buisinput"><br>
        <br>
        <label for="so" id="so1" class="buislabel">Second Owner:</label>
        <input type="text" id="so" name="so" placeholder="Second Owner" class="buisinput">
        <label for="eat" id="eat1" class="buislabel">Est. Annual Turnover:</label>
        <input type="text" id="eat" name="eat" placeholder="Est. Annual Turnover" class="buisinput"><br>
        <br>
        <label for="buiscity" id="buiscity1" class="buislabel">Buisness City:</label>
        <input type="text" id="buiscity" name="buiscity" placeholder="Buisness City" class="buisinput">
        <label for="buisdist" id="buisdist1" class="buislabel"> Buisness District:</label>
        <input type="text" id="buisdist" name="buisdist" placeholder="Buisness District" class="buisinput"><br>
        <br>
        <label for="buisstate" id="buisstate1" class="buislabel">State:</label>
        <input type="text" id="buisstate" name="buisstate" placeholder="TamilNadu" class="buisinput">
        <label for="buiscountrty" id="buiscountry1" class="buislabel">Country:</label>
        <input type="text" id="buiscountry" name="buiscountry" placeholder="India" class="buisinput">
        <br><br>
        <label for="buispincode" id="buispincode1" class="buislabel">Pin Code:</label>
        <input type="number" id="buispincode" name="buispincode" placeholder="600001" class="buisinput" onkeypress="if(this.value.length==6) return false;">
    </div>
    <br>
    <br>
    <input name="buisnesssubmit" type="submit" id="submit" value="Submit">
</body>
</html>